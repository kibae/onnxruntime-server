...
- [`1.24.3-linux-cuda13`](https://github.com/kibae/onnxruntime-server/blob/main/deploy/build-docker/linux-cuda13.dockerfile) amd64(CUDA 13.x, cuDNN 9.x)
- [`1.24.3-linux-cuda12`](https://github.com/kibae/onnxruntime-server/blob/main/deploy/build-docker/linux-cuda12.dockerfile) amd64(CUDA 12.x, cuDNN 9.x)
- [`1.24.3-linux-cpu`](https://github.com/kibae/onnxruntime-server/blob/main/deploy/build-docker/linux-cpu.dockerfile) amd64, arm64
...
services:
  ...
  onnxruntime_server_simple:
    ...
    image: kibaes/onnxruntime-server:1.24.3-linux-cuda13 # or 1.24.3-linux-cuda12
    ports:
